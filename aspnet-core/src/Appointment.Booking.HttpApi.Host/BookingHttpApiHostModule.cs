...
using Appointment.Booking.MultiTenancy;
            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<BookingDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Appointment.Booking.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<BookingDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Appointment.Booking.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<BookingApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Appointment.Booking.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<BookingApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Appointment.Booking.Application"));
            });
        }
    }
